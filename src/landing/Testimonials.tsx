...
const QUOTES: Quote[] = [
  {
    body:
      'DEVVIBES rebuilt the heart of our platform without taking it offline. We measured the impact in days, not quarters.',
    author: 'Mira Holst',
    role: 'CTO',
    company: 'HELIOS PAY',
  },
  {
    body:
      'The cleanest engineering culture we have worked with. They moved at the pace of our best teams and held the same bar on quality.',
    author: 'Daniel Cho',
    role: 'VP Product',
    company: 'PRISMA AI',
  },
  {
    body:
      'They embedded into our company and treated our roadmap like their own. The product their team shipped is now our flagship.',
    author: 'Hana Aldebaran',
    role: 'CEO',
    company: 'KAIROS',
  },
  {
    body:
      'The combination of strategy, design, and engineering inside one room is rare. We have stopped working with anyone else.',
    author: 'Ezra Bowman',
...
export default function Testimonials() {
  ...
  return (
    <section className="relative py-28 md:py-40 overflow-hidden" id="testimonials">
      ...
      <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-dv-deep rounded-full blur-[180px] opacity-30" />
              ...
              >
                ...
                <div className="mt-10 flex items-center justify-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-dv-cobalt to-dv-deep border border-white/10 flex items-center justify-center">
                    <span className="display text-sm">{q.author.split(' ').map(w => w[0]).join('')}</span>
                  </div>
